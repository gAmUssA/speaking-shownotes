...
<!-- Source: https://speaking.gamov.io/HEgbLn/crossing-the-streams-rethinking-stream-processing-with-kstreams-and-ksql -->
# Crossing the Streams: Rethinking Stream Processing with KStreams and KSQL

**Conference:** Toronto Kafka Meetup  
**Date:** 2018-11-29  
**Slides:** [View Slides](https://drive.google.com/file/d/1akk1F1dpK8MXvfVliyd6WArtcAyi5g9F/view)  

A presentation at Toronto Kafka Meetup in
                    November 2018 in
...
Viktor Gamov will introduce Kafka Streams and KSQL—an important recent addition to the Confluent open source platform that lets you build sophisticated stream processing systems with little to no code at all! He will talk about how to deploy stream processing applications and look at the actual working code that will bring your thinking about streaming data systems from the ancient history of batch processing into the current era of streaming data!
