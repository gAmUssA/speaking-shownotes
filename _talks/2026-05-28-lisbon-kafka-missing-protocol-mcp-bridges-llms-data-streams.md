...
<!-- Source: https://speaking.gamov.io/L36LNf/the-missing-protocol-how-mcp-bridges-llms-and-data-streams -->
# The Missing Protocol: How MCP Bridges LLMs and Data Streams

**Conference:** Lisbon Kafka Meetup  
**Date:** 2026-05-28  
**Slides:** [View Slides](https://drive.google.com/file/d/1L9OzyulntO6BEumt5_toV6QcyeRpn09U/view)  
**Video:** [Watch Video](https://www.youtube.com/watch?v=y85Xxx-vWZw)  

A presentation at Lisbon Kafka Meetup in
                    May 2026 in
                    Lisbon, Portugal by 
...
- [Confluent Cloud](https://confluent.io/confluent-cloud)
- [Learn Data Streaming](https://developer.confluent.io)
- [Kafka MCP](https://github.com/gamussa/mcp-kafka)
